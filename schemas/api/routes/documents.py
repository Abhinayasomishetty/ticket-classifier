...
async def process_document_background(doc_id: str, db: Session):
    ...
    try:
        ...
        print(f"Document {doc.original_filename} processed successfully: {len(chunks)} chunks")
...
async def search_knowledge(
    ...
    ticket.relevant_documents = [doc["filename"] for doc in result["sources"] if doc.get("filename")]
